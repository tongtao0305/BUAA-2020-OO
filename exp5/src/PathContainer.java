...
public class PathContainer {
    ...
    /*@ ensures \result == ([10] int i; 0 <= i && i < pidList.length; //TODO
      @                      pidList[i] == pathId);
      @*/
    ...
    /*@ public normal_behavior
      ...
      @ signals (PathNotFoundException e) [13] //TODO
    ...
    /*@ public normal_behavior
      ...
      @ public exceptional_behavior
      @ assignable \nothing;
      @ signals (PathIdNotFoundException e) [19] //TODO
      @*/
    ...
    public int getDistinctNodeCount() {//在容器全局范围内查找不同的节点数
        [20]; //TODO
        return globalNodesCount.keySet().size();
    }
    ...
    /*@ public normal_behavior
      ...
      @ assignable \nothing;
      @ ensures (pidList.length == pList.length);
      @ ensures (\exists int i; 0 <= i && i < pList.length; pidList[i] == pathId && \result == [22]); // TODO
      @ also
      @ public exceptional_behavior
      @ requires !containsPathId(pathId)
      @ assignable \nothing
